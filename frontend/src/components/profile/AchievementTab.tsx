interface Achievement {
  ...
  export default function AchievementTab({ unlocked, total, achievements }: AchievementTabProps) {
    return (
      <div className="bg-[#e8f4f9] rounded-xl p-6">
        <h3 className="text-lg font-semibold text-[#0a3b56] mb-4">Your Achievements</h3>
        <p className="text-gray-600 mb-4">You have unlocked {unlocked} out of {total} achievements.</p>
        ...
        {achievements.length > 4 && (
          <div className="mt-4 text-center">
            <a href="/achievement" className="text-sm font-medium text-[#0a3b56] hover:underline">
              View More
            </a>
          </div>
        )}
